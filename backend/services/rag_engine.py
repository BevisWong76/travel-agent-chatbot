...
async def query_rag(user_query: str) -> str:
    """ Search Pinecone for relevant documents and return concatenated context chunks (No LLM Call). """
    ...
    # 3. Return concatenated context for the agent to use in its reasoning
    context_list = []
